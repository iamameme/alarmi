...
export default {
  ...
  // Button
  btnFontFamily: platform === "ios" ? "AppleSDGothicNeo-Light" : "Roboto_medium",
  ...
  // Font
  DefaultFontSize: 16,
  fontFamily: platform === "ios" ? "AppleSDGothicNeo-Light" : "Roboto",
  fontSizeBase: 15,
  get fontSizeH1() {
  ...
  // Title
  titleFontfamily: platform === "ios" ? "American Typewriter" : "Roboto_medium",
